...
class ScraperController extends Controller
{
    ...
    {   
        ...
        $position = $crawler->filter("li[class='SearchResultsstyle__SearchResult-sc-c560t5-1 hlOmzw']")->each(function ($node) {
            return [
                'id' => Str::random(10),
    ...
    {   
        ...
        $crawler = $goutteClient->request('GET', $url);
        $position = $crawler->filter("div[class='JobCardsc__JobcardContainer-sc-1f9hdu8-0 hvpJwO CompactOpportunityCardsc__CompactJobCardWrapper-sc-1y4v110-0 dLzoMG compact_job_card']")->each(function ($node) {
            return [
                'id' => Str::random(10),
